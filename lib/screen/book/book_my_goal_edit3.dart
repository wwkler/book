...
class BookMyGoalEdit3 extends StatefulWidget {
  const BookMyGoalEdit3({super.key});

  @override
  State<BookMyGoalEdit3> createState() => _BookMyGoalEdit3State();
}

class _BookMyGoalEdit3State extends State<BookMyGoalEdit3> {
  // 목표 선택할 도서 분야에 대한 변수
  ...
  @override
  void dispose() {
    print("Book My Goal Edit3 dispose 시작");
    super.dispose();
  }
